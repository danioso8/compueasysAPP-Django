...
from core.views import add_to_cart, add_to_cart_detail, clear_cart, remove_from_cart, store, auctions, services, contactUs, aboutUs, cart, register, login, product_detail, checkout, update_cart
